...
public class ProfileActivityTest {
    ...
    public void profileActivityTest() {
        ...
        ViewInteraction materialEditText = onView(
                allOf(withId(R.id.user_fullname), withText("Student Test"),
                        childAtPosition(
                                childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        materialEditText.perform(replaceText("Student Test Test"));

        ViewInteraction materialEditText2 = onView(
                allOf(withId(R.id.user_fullname), withText("Student Test Test"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.support.v4.widget.NestedScrollView")),
                                        0),
        ...
        ViewInteraction textView3 = onView(
                allOf(withId(R.id.user_name), withText("Student Test Test"),
                        isDisplayed()));
        textView3.check(matches(withText("Student Test Test")));
