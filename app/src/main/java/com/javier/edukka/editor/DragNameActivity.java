...
public class DragNameActivity extends AppCompatActivity implements EasyPermissions.PermissionCallbacks{
    ...
    private static final String TAG = DragNameActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_drag_name);
    ...
    public void loadJSON() {
        ...
        request.enqueue(new Callback<QuizModel>() {
            ...
            public void onFailure(Call<QuizModel> call, Throwable t) {
                Toast.makeText(DragNameActivity.this, t.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    private boolean checkFieldValidation() {
        ...
        if(!loaded1 || !loaded2 || !loaded3 ) {
            Toast.makeText(DragNameActivity.this, R.string.need_3_images_error, Toast.LENGTH_LONG).show();
            valid = false;
        }
        return valid;
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == SEARCH_IMAGE) {
            if (resultCode == RESULT_OK) {
                ...
                path = null;
                Toast.makeText(DragNameActivity.this, R.string.image_error, Toast.LENGTH_LONG).show();
                switch (selected) {
                    case 1:
    ...
    public void save() {
        ...
        request.enqueue(new Callback<QuizModel>() {
            @Override
            public void onResponse(Call<QuizModel> call, Response<QuizModel> response) {
                Toast.makeText(DragNameActivity.this, R.string.quiz_saved, Toast.LENGTH_LONG).show();
            }
    ...
    public String uploadImage(Uri path, int position) {
        String res = "";
        if(path != null) {
            String filePath = getRealPathFromURIPath(path, DragNameActivity.this);
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        EasyPermissions.onRequestPermissionsResult(requestCode, permissions, grantResults, DragNameActivity.this);
    }
